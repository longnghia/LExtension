...
class Popup extends React.Component {
  ...
  removeTab = (pos) => {
    const item = this.state.tabs[pos];
    const newTabs = this.state.tabs.filter((tab) => tab != item);
  ...
  render() {
    const emptyImage = (<img width="100%" src={browser.runtime.getURL('images/empty_list.png')} />);
